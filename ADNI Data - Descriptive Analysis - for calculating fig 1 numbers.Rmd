...
adni2 <- adni1 %>% drop_na(MMSE, mPACCtrailsB)

# View(adni2)

print('cog test missing')
length(unique(adni2$RID))

# ----------------------------------------

adni3 <- adni2 %>% drop_na(APOE4)
...
adni5 <- adni4 %>% drop_na(DX)

length(unique(adni5$RID))
...
adni6 <- adni5 %>% drop_na(fam_hist_dad_dem, fam_hist_dad_ad, fam_hist_mum_dem, fam_hist_mum_ad)
# View(adni3)
length(unique(adni6$RID))
