...
recipes_list <- list(
  recipe_D = recipe(diagnosis_surv ~ AGE + SEX + EDU, data = surv_df1),
  recipe_F = recipe(diagnosis_surv ~ FH, data = surv_df1),
  recipe_DF = recipe(diagnosis_surv ~ AGE + SEX + EDU + FH, data = surv_df1),
  recipe_DGF = recipe(diagnosis_surv ~ AGE + SEX + EDU + APOE4 + FH, data = surv_df1),
  recipe_DGCF = recipe(diagnosis_surv ~ AGE + SEX + EDU + APOE4 + MMSE + mPACCtrailsB + FH, data = surv_df1),
  recipe_DGC = recipe(diagnosis_surv ~ APOE4 + AGE + SEX + EDU + MMSE + mPACCtrailsB, data = surv_df1)
)
