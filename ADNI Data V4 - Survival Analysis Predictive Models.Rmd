...
recipes_list <- list(
  recipe_3 = recipe(diagnosis_surv ~ fam_hist_dad_ad + fam_hist_mum_ad + APOE4 + AGE, data = surv_df1),
  recipe_4 = recipe(diagnosis_surv ~ fam_hist_dad_ad + fam_hist_mum_ad + APOE4 + AGE + PTGENDER, data = surv_df1),
  recipe_5 = recipe(diagnosis_surv ~ fam_hist_dad_ad + fam_hist_mum_ad + APOE4 + AGE + PTGENDER + MMSE, data = surv_df1),
  recipe_6 = recipe(diagnosis_surv ~ fam_hist_dad_ad + fam_hist_mum_ad + APOE4 + AGE + PTGENDER + MMSE + mPACCtrailsB, data = surv_df1),
  recipe_7 = recipe(diagnosis_surv ~ fam_hist_dad_ad + fam_hist_mum_ad + APOE4 + AGE + PTGENDER + MMSE + mPACCtrailsB + PTEDUCAT, data = surv_df1),
...
-   Recipe 1 (with all covariates: APOE4 + AGE + PTGENDER + MMSE) has more variability in model performance, especially for Cox

-   Recipes 2 and 3 (with fewer covariates) tend to show more stable and often better performance, particularly for the RandomForest and Weibull models
