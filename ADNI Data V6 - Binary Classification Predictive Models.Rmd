...
Binaryglm_All_0 <- ggplot(summary_metrics, aes(x = feature_set, y = .estimate, fill = Model)) +
  geom_boxplot() +
...
ggsave("Binaryglm_All_0.png", plot = Binaryglm_All_0, width = 10, height = 10)
...
Binaryglm_All_0 <- ggplot(all_metrics, aes(x = feature_set, y = .estimate, fill = Model)) +
  geom_boxplot() +
  facet_wrap(~ .metric, scales = "free_y") +
  labs(title = "Binary Classification - Comparison of Feature Sets Across Best Model", 
       x = "Feature Set(s)", 
