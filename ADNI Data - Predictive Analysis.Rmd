...
surv_recipe1 <- recipe(event ~ fam_hist_dad_dem + fam_hist_dad_ad + fam_hist_mum_dem + fam_hist_mum_ad + PTGENDER, data = train_data)

surv_recipe2 <- recipe(event ~ mPACC_group + MMSE_group + education_group, data = train_data)
